(function () {
  ...
  Game.prototype.fireBullet = function () {
    ...
    var pos = addVects(this.ship.pos, scale(this.ship.facing(),
        Sassteroids.Ship.RADIUS - 12));

    var firingVel = rotateVect([Sassteroids.Bullet.SPEED, 0], this.ship.angle);
    var vel = addVects(this.ship.vel, firingVel);
