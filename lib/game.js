(function () {
  ...
  Game.prototype.fireBullet = function () {
    ...
    var vel = Array(2);
    // for (var i = 0; i < 2; i++) {
//       pos[i] = this.ship.pos[i] + this.ship.direction()[i] *
//           (Sassteroids.Ship.RADIUS + 4);
//           console.log(this);
//       vel[i] = (this.ship.speed() + Sassteroids.Bullet.SPEED) *
//           this.ship.direction()[i];
//     }

    var pos = this.ship.pos; // FIX THIS!!
    var pos = Utils.addVects(pos, Utils.scale(this.ship.direction(), Sassteroids.Ship.RADIUS + 4));

    var bulletSpeed = this.ship.speed() + Sassteroids.Bullet.SPEED;
    var vel = Utils.scale(this.ship.direction(), bulletSpeed);
